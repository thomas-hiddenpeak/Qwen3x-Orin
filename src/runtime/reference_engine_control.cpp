...
GenerationControlResult run_generation_control_impl(
  ...
  try {
    ...
    if (options.prefill_layer_major_prompt) {
      ...
      control.timing.mlp_k256_m128n256_pairfeed_package_launch_hits =
          outcome.value
      ...
      control.timing.gateup_m128n64_same_cta_launch_hits =
          outcome.value->gateup_m128n64_same_cta_launch_hits;
      control.timing.gateup_m128n512_fused_quantize_launch_hits =
      ...
      control.timing.gateup_m64n8_paired_warp_register_pipeline_launch_hits =
          outcome.value
