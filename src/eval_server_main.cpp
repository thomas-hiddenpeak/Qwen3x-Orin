...
void PrintUsage(std::ostream& output) {
  output
      ...
      << "                              Authenticated 64-projection K512 overlay\n"
      << "  --prefill-attention-o-k512-policy FILE\n"
      << "                              Matching K512 calibration policy (required)\n"
      << "  --prefill-attention-o-k512-receipt FILE\n"
      << "                              Matching K512 publication receipt (required)\n"
      << "  --prefill-mlp-k512-payload FILE\n"
      << "                              Authenticated 192-projection K512 MLP overlay\n"
      << "  --prefill-mlp-k512-policy FILE\n"
      << "                              Matching MLP K512 policy (required)\n"
      << "  --prefill-mlp-k512-receipt FILE\n"
      << "                              Matching MLP K512 receipt (required)\n"
      << "  --prefill-mlp-k512-fragment-native-payload FILE\n"
      << "                              Authenticated fragment-native MLP K512 v2\n"
      << "  --prefill-mlp-k512-fragment-native-policy FILE\n"
      << "                              Exact source-v1 policy bound by v2 receipt\n"
      << "  --prefill-mlp-k512-fragment-native-receipt FILE\n"
      << "                              Matching fragment-native v2 receipt\n"
      << "  --prefill-mlp-k512-paired-gateup-canonical-down-payload FILE\n"
      << "                              Authenticated paired-GateUp/canonical-Down hybrid\n"
      << "  --prefill-mlp-k512-paired-gateup-canonical-down-policy FILE\n"
      << "                              Exact source-v1 policy bound by hybrid receipt\n"
      << "  --prefill-mlp-k512-paired-gateup-canonical-down-receipt FILE\n"
      << "                              Matching independent hybrid receipt\n"
      << "  --prefill-mlp-k512-projection-major-gateup-canonical-down-payload FILE\n"
      << "                              Authenticated projection-major-GateUp hybrid\n"
      << "  --prefill-mlp-k512-projection-major-gateup-canonical-down-policy FILE\n"
      << "                              Exact source-v1 policy bound by receipt\n"
      << "  --prefill-mlp-k512-projection-major-gateup-canonical-down-receipt FILE\n"
      << "                              Matching independent projection-major receipt\n"
      << "  --prefill-mlp-factorized-lane-r1-payload FILE\n"
      << "                              Authenticated R1 MLP upper-bound payload\n"
      << "  --prefill-mlp-factorized-lane-r1-policy FILE\n"
      << "                              Matching R1 factor/clip policy\n"
      << "  --prefill-mlp-factorized-lane-r1-receipt FILE\n"
      << "                              Matching default-off experiment receipt\n"
      << "  --prefill-attention-factorized-lane-r1-payload FILE\n"
      << "                              Authenticated 208-projection Attention R1 payload\n"
      << "  --prefill-attention-factorized-lane-r1-policy FILE\n"
      << "                              Matching Attention R1 factor/clip policy\n"
      << "  --prefill-attention-factorized-lane-r1-receipt FILE\n"
      << "                              Matching upper-bound-only receipt\n"
      << "  --prefill-mlp-factorized-lane-r4-payload FILE\n"
      << "                              Direct-checkpoint R4 performance candidate\n"
      << "  --prefill-mlp-factorized-lane-r4-policy FILE\n"
      << "                              Matching R4 factor/clip policy\n"
      << "  --prefill-mlp-factorized-lane-r4-receipt FILE\n"
      << "                              Matching performance-only R4 receipt\n"
