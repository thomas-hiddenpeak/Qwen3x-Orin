---
q3x_document:
  id: q3x-roadmap-legacy
  class: historical
  status: historical
  owner: project-maintainers
  authority: none; preserved pre-SDD roadmap and experiment ledger
...
> **Document control**
> - Class: `historical_ledger`
> - Authority: historical evidence for the exact recorded commits/protocols
> - Status: historical and superseded for planning
> - Superseded by: [`ROADMAP.md`](ROADMAP.md)
> - Frozen on: 2026-08-09

The body below is retained as the pre-SDD append-only roadmap. Statements such
as `current`, `active`, `next`, `production`, and `terminal` describe their
historical context only and must not guide present work.
