...
### Draft candidate: private terminal-prefix execution

The isolated `WP-TERMINAL-LAYER-LIVENESS-20260909` candidate adds an
...
This draft specifies the isolated candidate's obligations; it grants no
P40000/O16, API, performance, release, or mainline qualification.
