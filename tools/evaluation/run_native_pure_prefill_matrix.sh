...
mode=exact
gdn_prompt_span_baseline_mode=cumulative-prefill-current-best-mlp-k512-edge-m64n128-k256-alternating-down-16warp-pairring-attention-k256-a-exchange-b4
...
if [[ "${mode}" == "${gdn_prompt_span_baseline_mode}" ||
