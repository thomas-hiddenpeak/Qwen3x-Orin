if(NOT DEFINED Q3X_PROVENANCE_SOURCE_DIR OR
  ...
  message(FATAL_ERROR "incomplete real-P40 arithmetic witness provenance inputs")
endif()
...
if(NOT git_commit_status EQUAL 0 OR NOT git_tree_status EQUAL 0 OR
  ...
  message(FATAL_ERROR
    "cannot freeze real-P40 arithmetic witness git provenance: "
...
string(SHA256 Q3X_PROVENANCE_GIT_STATUS_SHA256
...
if(EXISTS "${Q3X_PROVENANCE_LAUNCHER_SOURCE}")
  file(SHA256 "${Q3X_PROVENANCE_LAUNCHER_SOURCE}"
       Q3X_PROVENANCE_LAUNCHER_SOURCE_SHA256)
else()
  set(Q3X_PROVENANCE_LAUNCHER_SOURCE_SHA256 "unavailable")
endif()
if(EXISTS "${Q3X_PROVENANCE_PREFLIGHT_SOURCE}")
  file(SHA256 "${Q3X_PROVENANCE_PREFLIGHT_SOURCE}"
       Q3X_PROVENANCE_PREFLIGHT_SOURCE_SHA256)
else()
  set(Q3X_PROVENANCE_PREFLIGHT_SOURCE_SHA256 "unavailable")
endif()

foreach(boolean_name IN ITEMS
    Q3X_PROVENANCE_BUILD_TESTING
    Q3X_PROVENANCE_AOT_SYSTEM_ADMISSION
    Q3X_PROVENANCE_ARITHMETIC_WITNESS_ADMISSION)
  if(${boolean_name})
...
string(CONCAT build_receipt
  "schema=q3x.sm87.aot-system-v1.real-p40-arithmetic-witness-build.v1\n"
  "git_commit=${Q3X_PROVENANCE_GIT_COMMIT}\n"
  "git_tree=${Q3X_PROVENANCE_GIT_TREE}\n"
  "git_clean=${Q3X_PROVENANCE_GIT_CLEAN}\n"
  "git_status_sha256=${Q3X_PROVENANCE_GIT_STATUS_SHA256}\n"
  ...
  "launcher_source_sha256=${Q3X_PROVENANCE_LAUNCHER_SOURCE_SHA256}\n"
  "preflight_source_sha256=${Q3X_PROVENANCE_PREFLIGHT_SOURCE_SHA256}\n"
  "enabled_q3x_build_options=${Q3X_PROVENANCE_ENABLED_Q3X_BUILD_OPTIONS}\n"
  "aot_system_admission=${Q3X_PROVENANCE_AOT_SYSTEM_ADMISSION}\n"
  "arithmetic_witness_admission=${Q3X_PROVENANCE_ARITHMETIC_WITNESS_ADMISSION}\n"
)
...
foreach(value_name IN ITEMS
    ...
    Q3X_PROVENANCE_GIT_STATUS_SHA256
    ...
    Q3X_PROVENANCE_LAUNCHER_SOURCE_SHA256
    Q3X_PROVENANCE_PREFLIGHT_SOURCE_SHA256
    Q3X_PROVENANCE_ENABLED_Q3X_BUILD_OPTIONS
...
if(NOT copy_status EQUAL 0)
  message(FATAL_ERROR "cannot publish real-P40 arithmetic witness provenance header")
endif()
